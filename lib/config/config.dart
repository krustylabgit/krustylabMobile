...
class Config {
  ...
  static const appName = 'Krustylab';
  static const supportEmail = 'krustylab@gmail.com';
  static const privacyPolicyUrl = 'https://www.krustylab.com/privacy-policy';
  static const iOSAppID = '000000';



  //SOCIAL LINKS
  static const String facebookPageUrl = 'https://www.facebook.com/krustylab';
  static const String youtubeChannelUrl = 'https://www.youtube.com/channel/UCMb6Gt53oiSLMBgbD6moDsg';
  static const String twitterUrl = 'https://twitter.com/krustylab';
  


  //app theme color
  final Color appThemeColor = Color(0xff3588ea);
